...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    add_entities([RepsolLuzYGazEntity(client, 'Amount', 'amount', '€', True),
                ...
                RepsolLuzYGazEntity(client, 'Last invoice was paid', 'last_invoice_paid', '',  False),
                RepsolLuzYGazEntity(client, 'Next Invoice Estimated Amount', 'nextInvoice', '€',  False)], True)
